...
async function requestFeedback() {
  ...
  - 숫자마다 단위를 반복하지 않아도 되며, "추의 개수가 1, 2, 3개일 때, 용수철의 길이는 4, 8, 12cm가 된다","반려 식물의 키를 관찰하기 시작한지 1, 2, 3주일 때, 식물의 키는 2, 4, 6cm가 된다", "꾸러미 개수가 1,2,3,4,5개일 때 모자의 개수는 2,4,6,8,10개가 된다"
  ...
  - "1,2,3,4,5주일 때 2,4,6,8,10cm가 된다"처럼 작성했을 경우, **무엇이 ~일 때, 무엇은 ~된다**와 같이 피드백을 줘.
  ...
  - “다른 그래프를 해석해 보세요!”는 반드시 학생이 **양적 해석과 전체 경향을 모두 충족**할 때만 출력해야 해.
  `; 
