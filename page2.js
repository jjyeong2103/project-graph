...
async function requestFeedback() {
  ...
  6. 학생이 단위도 틀리지 않고, 각각의 점과 전체적인 해석을 모두 잘 했다면, 마지막 줄에 **반드시 "다른 그래프를 해석해 보세요!"**라고 말해줘. **절대 "다른 그래프도", "더 다양한 그래프를"라고 쓰지마.**
  </피드백 단계>
  ...
  - 피드백은 **오직 수학적 해석(x축 이름과 y축 이름, 관계 파악, 단위 포함, 점별 해석 여부)에만 집중**해.
