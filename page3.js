  ...
  const problemSets = [
    {
      ...
      - 양적 접근(점별): 그래프 위 최소 두 점에 대한 언급(전체적 접근과 겹치는 부분이 생길 수도 있음)
    ...
    },
    {
      ...
      yAxisLabel: "속력(km/h)",
      pattern: "속력변화",
      question: "자율 주행 자동차의 운행 시간과 속력 사이의 관계를 나타낸 그래프입니다. 이를를 해석해 보세요.",
      rubric: `
      - 질적 접근: 그래프 모양에 대한 언급()
      `
    },
...
chart = new Chart(ctx, {
  ...
  6. 학생이 단위도 틀리지 않고, 각각의 점과 전체적인 해석을 모두 잘 했다면, 마지막 줄에 **반드시 "다른 그래프를 해석해 보세요!"**라고 말해줘.
